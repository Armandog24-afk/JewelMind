...
This Bible now spans two Sprints:
...
Both Sprints are documentation milestones: no application code behavior
was changed to produce them, beyond the tiny naming corrections noted in
each document's own text where applicable.
