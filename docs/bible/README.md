...
This Bible now spans four Sprints:
...
All four Sprints are documentation milestones: no application code
...
and Sprint 4's small additive test-only dependency (`jsonschema`) and test
