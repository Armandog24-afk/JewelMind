...
| Band | `BandSpec` | `BandSpec` | `_band_rules` | `geometry/components/band.py` | `solitaire.py` | same | `step_exporter.py`, `stl_exporter.py`, `specification.py` | `ConfigurationPanel.tsx` (Band section) | `test_validation.py`, `test_geometry.py` |
| Stone reference | `StoneSpec` | `StoneSpec` | `_stone_rules` | `geometry/components/stone.py` | `solitaire.py` | same | Excluded by default; opt-in via `includeStoneReference` | `ConfigurationPanel.tsx` (Stone section) | `test_validation.py`, `test_geometry.py` |
